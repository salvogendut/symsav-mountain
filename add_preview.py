#!/usr/bin/env python3
"""Insert screensaver preview image into mountain.sav at code offset 256."""
...
MOUNTAIN_SAV  = os.path.join(os.path.dirname(__file__), 'mountain.sav')
